...
trigger_config_reloads() {
    ...
    # rofi needs no reload signal: script-mode backend re-renders per
    # interaction; rasi re-imports colors.rasi at next launch. Killing rofi
    # here closed the control center mid-interaction (2026-09-26 bug).
}
